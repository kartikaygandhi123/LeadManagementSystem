        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-md-6 col-12">
                <div class="box box-body bg-info">
                    <div class="flexbox">
                        {{-- <div id="spark2"></div> --}}
                        <span class="font-size-40 font-weight-200">{{ isset($stage['Requirements Mapping'])? $stage['Requirements Mapping'] : 0 }}</span>
                    </div>
            ...
            <div class="col-xl-3 col-md-6 col-12">
                <div class="box box-body bg-info">
                    <div class="flexbox">
                        {{-- <div id="spark3"></div> --}}
                        <span class="font-size-40 font-weight-200">{{ isset($stage['Proposal'])? $stage['Proposal'] : 0 }}</span>
                    </div>
            ...
            <div class="col-xl-3 col-md-6 col-12">
                <div class="box box-body bg-warning">
                    <div class="flexbox">
                        {{-- <div id="spark4"></div> --}}
                        <span class="font-size-40 font-weight-200">{{ isset($stage['Negotiation'])? $stage['Negotiation'] : 0 }}</span>
                    </div>
     ...
     <div class="row">
            ...
            <div class="col-xl-3 col-md-6 col-12">
                <div class="box box-body bg-info">
                    <div class="flexbox">
                        {{-- <div id="spark2"></div> --}}
                        <span class="font-size-40 font-weight-200">{{ isset($stage['Agreement'])? $stage['Agreement'] : 0 }}</span>
                    </div>
            ...
            <div class="col-xl-3 col-md-6 col-12">
                <div class="box box-body bg-success">
                    <div class="flexbox">
                        {{-- <div id="spark3"></div> --}}
                        <span class="font-size-40 font-weight-200">{{ isset($stage['Business Onboarded'])? $stage['Business Onboarded'] : 0 }}</span>
                    </div>
            ...
            <!-- /.col -->
             ...
             <div class="col-xl-3 col-md-6 col-12">
                <div class="box box-body bg-danger">
                    <div class="flexbox">
                        {{-- <div id="spark2"></div> --}}
                        <span class="font-size-40 font-weight-200">{{ isset($stage['Dormant'])? $stage['Dormant'] : 0 }}</span>
                    </div>
