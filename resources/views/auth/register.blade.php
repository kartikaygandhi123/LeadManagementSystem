...
<body class="hold-transition">
    ...
    <div class="container h-p100 h-xs-auto">
        <div class="row h-p100 align-items-center">
            <div class="col-12">
                <div class="text-center">
                    ...
                    <h1><i class="fa fa-warning text-primary"></i> Internal Server Error !</h1>
                    <p class="zoom-area">External Registration Not Allowed</p>

                    <a href="login" class="btn btn-primary mb-5">Back to Login</a>
                </div>
            </div>
        </div>
    </div>
