            ...
            <tbody>
                <tr>
                    <td style="background:#ffffff;padding:16px 0">
                        <table
                            style="max-width:600px;margin:auto;border-spacing:0;background:#17a2b8;padding:4px;border-radius:16px;overflow:hidden"
                            align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tbody>
                                <tr>
                                    <td style="border-collapse:collapse">
                                        <table
                                            style="margin:auto;border-spacing:0;background:white;border-radius:12px;overflow:hidden"
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="border-collapse:collapse">
                                                        <table style="border-spacing:0;border-collapse:collapse"
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td style="border-collapse:collapse;padding:16px 32px"
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td width="100%" align="center"
                                                                                        ...
                                                                                        <h2>LMS: Follow-Up</h2>
                                                                                        <hr
                                                                                            style="display: block; height: 1px;border: 0; border-top: 1px solid #17a2b8;margin: 1em 0; padding: 0; width:40%;">
                                                                                        </hr>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                ...
                                                <tr>
                                                    <td
                                                        style="border-collapse:collapse;padding:32px;background:#ffffff;font-family:'roboto',Arial,Helvetica,sans-serif">
                                                        <center>
