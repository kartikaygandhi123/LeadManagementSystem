                        ...
                        @foreach ($leads as $item)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="view_lead_legal/{{ $item->id }}"><span class="ti-eye lg\:absolute"
                                            style="font-size:19px;color:#17a2b8"></span></a>

                                    <!-- <a onclick="Edit_Lead('{{ $item->id }}')" data-toggle="modal" data-target="#modal-center1"><span class="ti-write"></span></a>-->
                                </td>
